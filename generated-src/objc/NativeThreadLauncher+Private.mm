...
: public ::djinni_rest_gen::ThreadLauncher
, public ::djinni::ObjcProxyCache::Handle<ObjcType>
{
public:
    using Handle::Handle;
    void start_thread(const std::string & c_name, const std::shared_ptr<::djinni_rest_gen::AsyncTask> & c_run_fn) override
    {
        @autoreleasepool {
